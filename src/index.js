...
import DApp from './CountryNatives(API-fetching)/0_Practice/DApp';
import App2 from './paltrows-power-toes/App';
import App3 from './paltrows-power-toes2/App';
import Tabs3 from './practice/Tabs3/Tabs3';
...
// ReactDOM.render(<Tabs3 tabs={tabs} />, document.getElementById('root'));

// ReactDOM.render(<Accordian sections={sections} />, document.getElementById('root'));
// ReactDOM.render(<Accordian2 sections={sections} />, document.getElementById('root'));
